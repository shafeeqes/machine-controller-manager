...
const (
	...
	// LabelKeySkipMachineSetUpdate is the label key for the machine indicating the machine set update should be skipped.
	LabelKeySkipMachineSetUpdate = "machine.sapcloud.io/skip-machine-set-update"
)
