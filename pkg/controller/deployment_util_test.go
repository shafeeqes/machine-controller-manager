...
var _ = Describe("deployment_util", func() {
	...
	DescribeTable("#MaxUnavailable",
		...
		// Case: InPlaceUpdate strategy with OnLabel=true
		Entry("strategy is InPlaceUpdate with OnLabel=true, maxUnavailable=2, replicas=5",
			machinev1.MachineDeploymentStrategy{
		...
		// Case: InPlaceUpdate strategy with OnLabel=false and maxUnavailable > replicas
		Entry("strategy is InPlaceUpdate with OnLabel=false, maxUnavailable=10, replicas=3",
			machinev1.MachineDeploymentStrategy{
				Type: machinev1.InPlaceUpdateMachineDeploymentStrategyType,
				InPlaceUpdate: &machinev1.InPlaceUpdateMachineDeployment{
					UpdateConfiguration: machinev1.UpdateConfiguration{
		...
		// Case: InPlaceUpdate strategy with OnLabel=true and replicas=0
		Entry("strategy is InPlaceUpdate with OnLabel=true, replicas=0",
			machinev1.MachineDeploymentStrategy{
				Type: machinev1.InPlaceUpdateMachineDeploymentStrategyType,
				InPlaceUpdate: &machinev1.InPlaceUpdateMachineDeployment{
					OnLabel: true,
	...
	DescribeTable("#NewISNewReplicas",
		...
		// Case: InPlaceUpdate strategy with OnLabel=true
		Entry("InPlaceUpdate with OnLabel=true",
			machinev1.MachineDeploymentStrategy{
				Type: machinev1.InPlaceUpdateMachineDeploymentStrategyType,
				InPlaceUpdate: &machinev1.InPlaceUpdateMachineDeployment{
					OnLabel: true,
		...
		// Case: InPlaceUpdate strategy with OnLabel=false, scaling up within max surge
		Entry("RollingUpdate, scale up within max surge",
			machinev1.MachineDeploymentStrategy{
				Type: machinev1.InPlaceUpdateMachineDeploymentStrategyType,
				InPlaceUpdate: &machinev1.InPlaceUpdateMachineDeployment{
		...
		// Case: InPlaceUpdate strategy with OnLabel=false and max surge already reached
		Entry("InPlaceUpdate with OnLabel=false, max surge already reached",
			machinev1.MachineDeploymentStrategy{
				Type: machinev1.InPlaceUpdateMachineDeploymentStrategyType,
				InPlaceUpdate: &machinev1.InPlaceUpdateMachineDeployment{
					UpdateConfiguration: machinev1.UpdateConfiguration{
