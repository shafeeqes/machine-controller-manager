...
func schema_pkg_apis_machine_v1alpha1_InPlaceUpdateMachineDeployment(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Spec to control the desired behavior of in-place update.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"maxUnavailable": {
						SchemaProps: spec.SchemaProps{
					...
					"onLabel": {
						SchemaProps: spec.SchemaProps{
							Description: "Determine whether the update should be done only on label.",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"inPlaceUpdate": {
						SchemaProps: spec.SchemaProps{
							Description: "InPlace update config params. Present only if MachineDeploymentStrategyType = InPlaceUpdate.",
