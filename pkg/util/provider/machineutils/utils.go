...
const (
	...
	// NodeDrainSuccessful specifies next step as node ready for update.
...
const (
	...
	MediumRetry RetryPeriod = RetryPeriod(30 * time.Second)
	// LongRetry tells the controller to retry after a long duration - 10 minutes
	LongRetry RetryPeriod = RetryPeriod(30 * time.Second)
)
